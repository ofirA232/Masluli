    ...
    <>
      ...
      <main className="section-wrap legal-page">
        ...
        {privacy ? (
          <>
            <p>
              Masluli שומרת את פרטי החשבון ואת הטיולים שבחרתם ליצור באמצעות
          ...
          <>
            <p>
              Masluli היא כלי לתכנון טיולים. מסלולי AI ואומדני עלות הם הצעות
            ...
            <p>
              ...
              מקומות מיועדים לבדיקה ולהמשך הזמנה אצל הספק; Masluli אינה מעבדת
              הזמנות או תשלומים.
            </p>
            <p>
